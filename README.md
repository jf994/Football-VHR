...
Modificare il file `options.csv` inserendo i seguenti dati separati da virgola:
    ...
    ```
    path relativo del video desiderato, thrashold per darknet (valore tra zero e uno, l'analisi è stata testata per 0.55), numero checkpoint raggiunto durante il training, framerate del video originale
    ```
